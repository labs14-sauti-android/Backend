...
public class GraphQLController {
    ...
    public GraphQLController(MarketPriceService marketPriceService) {
    ...
    @PostMapping(value="/graphql", consumes = MediaType
            .APPLICATION_JSON_UTF8_VALUE, produces = MediaType
